...
def get_data(my_date: datetime.date) -> str:
    ...
    month=str(my_date.month) if my_date.month>9 else '0'+ str(my_date.month)
    day=str(my_date.day) if my_date.day>9 else '0'+ str(my_date.day)
...
def get_usd() -> None:
    ...
    with open('data.csv', 'w', newline='',encoding="utf-8") as file:
        while my_date.year>2014:
            url = "https://www.cbr-xml-daily.ru/archive/" +get_data(my_date)+ "/daily_json.js"
